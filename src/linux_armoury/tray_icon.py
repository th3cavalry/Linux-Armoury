...
class SystemTrayIcon:
    ...
    def _apply_profile(self, profile: str):
        """Apply power profile"""
        valid_profiles = ['emergency', 'battery', 'efficient', 'balanced', 
                         'performance', 'gaming', 'maximum']
    ...
    def set_visible(self, visible: bool):
        ...
        if self.sni:
            ...
            status = AppIndicator.IndicatorStatus.ACTIVE if visible else AppIndicator.IndicatorStatus.PASSIVE
    ...
    def update_status_text(self, cpu_temp: float = None, battery: int = None, 
                          profile: str = None):

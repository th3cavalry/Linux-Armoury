...
class SystemUtils:
    ...
    def _set_refresh_rate_wayland(rate: int) -> Tuple[bool, str]:
        ...
        if not tool:
            return (False, "No Wayland display configuration tool found. Install wlr-randr or use GNOME Settings.")
    ...
    def set_power_profile(profile: str) -> Tuple[bool, str]:
        ...
        if profile not in valid_profiles:
            return (False, f"Invalid profile: {profile}. Available: {', '.join(valid_profiles)}")
                ...
                for line in result.stdout.split('\n'):
                    if 'VGA' in line or '3D' in line or 'Display' in line:
                        ...
                        if 'nvidia' in name_lower:
                            ...
                            if 'vega' in name_lower or 'integrated' in name_lower or 'apu' in name_lower:

...
1. Done! Settings apply immediately
...
1. Toggle "Start on Boot"
1. Done! App will launch when you log in
...
1. If it's not `eDP-1`, the code needs updating. Please report this as an issue on GitHub with your output name.
...
1. **Check if your desktop supports system tray:**
...
1. Check for memory leaks (report as bug)
1. Check system resources in general
